...
ob_start();
 ...
 {  
      ...
      $obj_pdf->SetTitle("Faculty of Technology - Subjects Report");  
      ...
      $content = '';  
      $content .= '  
      <h3 align="center">Faculty of Technology - Subjects Report</h3><br /><br />  
      <table border="1" cellspacing="0" cellpadding="5">  
           <tr>  
                <th width="20%">Subject Code</th>  
                <th width="40%">Subject Name</th>  
                <th width="20%">Creditsr</th>  
                <th width="20%">Lecture Hours</th>  
           </tr>  
      ';  
      $content .= fetch_data();  
      $content .= '</table>';  
      $obj_pdf->writeHTML($content);  
      $obj_pdf->Output('subject.pdf', 'I');  
 }  
 ?>  
 <!DOCTYPE html>  
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Faculty of Technology - Subjects Report</h3><br />  
