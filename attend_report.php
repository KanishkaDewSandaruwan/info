...
if(isset($_REQUEST['date'])){
	 ...
	 {  
	      ...
	      $connect = mysqli_connect("localhost", "root", "", "atendance");
	      	...
	      	$q4 = "SELECT * FROM subject where sub_code = '".$_REQUEST['code']."'"; 
            $res4 = mysqli_query($connect,$q4);
            $row5 = mysqli_fetch_assoc($res4);

	      $sql = "SELECT * FROM lec_attend join student_reg on lec_attend.reg_number = student_reg.reg_number join lec_calander on lec_attend.cal_date = lec_calander.cal_date  where lec_calander.date ='".$_REQUEST['date']."' AND subject_code = '".$_REQUEST['code']."'"; 
	 ...
	 {  
	      ...
	      $content = '';  
	      $content = '  
	      <h3 align="center">Faculty of Technology - Lecture Attendance Details Report</h3><br /><br /> 
	      <table border="1" cellspacing="0" cellpadding="5">  
	           <tr>  
	                <th width="20%">Date</th>  
	                <th width="20%">Registration Number</th>  
	                <th width="10%">Lecture Hours</th>  
	      ...
	      $obj_pdf->Output(''.$_REQUEST['date'].'_'.$_REQUEST['code'].'_Attendance.pdf', 'I');  
	 }  
 ...
 <html>  
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">
                ...
                <h3 align="center">Faculty of Technology - Lecture Attendance Details Report</h3><br />  
                <div class="table-responsive"> 
                     <table class="table table-bordered" style="width: 100%; border: 1px solid red;">  
                          <tr>  
                               <th width="10%">Date</th>  
                               <th width="20%">Registration Number</th>  
                               <th width="5%">Lecture Hours</th>  
