...
<form class="edit_page" action="username_change.php" method="POST">
			...
			<button class="reg_but button1" type="button" name="sign_sub" onclick="window.location.href='index2.php'">Go back Home</button>
</form>
<?php
	if(isset($_POST['sign_sub']))
	{
		...
		if(!empty($uname))
		{
			$query1="SELECT * FROM lecture WHERE lec_username='$uname'";
			$sql1=mysqli_query($con,$query1);
				...
				{
					$query3="UPDATE lecture SET lec_username='$uname' WHERE lec_username='".$g."'";
